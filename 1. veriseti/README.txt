...
**Ana Özellikler:**
- Hibrit Vektör Oluşturma: GloVe embeddings + TF-IDF ağırlıklı kategori vektörleri (300D → 1200D)
- Eksik Kelime İşleme: GloVe'de olmayan kelimeler için TF-IDF bazlı KNN ile vektör oluşturma
- 4 farklı ML modeli: LogisticRegression, SVM, MLP, GradientBoosting
- PCA boyut indirgeme: 1200D → 100D (hız optimizasyonu için)
...
2. GloVe embeddings yükleme (300D)
...
**Kategoriler:** 1=World, 2=Sports, 3=Business, 4=Sci/Tech
...
1. **İlk olarak topic_classifier_training.ipynb çalıştırın:**
   ...
   - Uzun sürüypr yaklaşık 5-6 saat fln
...
**Veri Dosyaları:**
- archive/train.csv (eğitim verisi) (ag news)
...
- glove/glove.6B.300d.txt (word embeddings)

## Teknik Detaylar

**Hibrit Vektör Yapısı:**
- GloVe 300D base vector
- 4 kategori × 300D = 1200D hibrit vektör
- Her kategori için TF-IDF ağırlıklı vektör bileşeni
- PCA ile 100D'a indirgeme (hız için)

**Model Mimarisi:**
- LogisticRegression: Tam boyutlu hibrit vektörler (1200D)
